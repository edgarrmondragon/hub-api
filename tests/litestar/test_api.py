...
@pytest.mark.xfail(
    reason=(
        "Litestar doesn't response with 'Allow' header. "
        "Waiting for https://github.com/litestar-org/litestar/pull/4289 "
        "(https://github.com/litestar-org/litestar/issues/4277) "
        "to be released"
    ),
    strict=True,
    raises=KeyError,
